  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Manage user accounts, roles, and custom quotas</p>
      </div>
          ...
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="text-left py-3 px-4 font-semibold text-sm">Organizations</th>
                      ...
                      {user.organizations.length > 0 ? (
                        <div className="flex flex-wrap gap-1">
                          {user.organizations.slice(0, 2).map((org) => (
                            <span key={org.id} className="px-2 py-1 bg-blue-100 text-blue-700 rounded text-xs">
        ...
        {editingQuotas && (
          <div className="p-6 border-t border-gray-200 bg-gray-50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Image Generation Count</label>
                <input
                  type="number"
